    ...
    <section aria-labelledby="testimonials-heading" className="relative py-24 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20">
        <div className="text-center mb-10">
          <p className="text-xs uppercase text-[#60d1db] tracking-wider mb-2">★ Testimonials</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center">
              ...
              <div className="p-6 md:p-8">
                <blockquote className="text-gray-700 mb-4 text-lg md:text-xl leading-relaxed">
                  “They transformed our online presence and brought us more customers than we imagined.”
                </blockquote>
                <div className="text-sm text-gray-500 mb-6">Maya Olivia — Marketing Lead at Urban Bloom</div>
          ...
          <article className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 items-center">
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="text-sm text-gray-500 mb-6">Nadya Sarah — Founder of Matcha Mood</div>

                <div className="flex gap-4 flex-wrap">
                  <div className="bg-[#f7fbfb] border border-gray-100 rounded-lg px-4 py-3">
                    <div className="text-xs text-gray-500">Social Impressions</div>
                    <div className="font-semibold text-xl text-gray-900">520<span className="text-[#60d1db]">K+</span></div>
                  </div>

                  <div className="bg-[#f7fbfb] border border-gray-100 rounded-lg px-4 py-3">
                    <div className="text-xs text-gray-500">Content Save Growth</div>
                    <div className="font-semibold text-xl text-gray-900">180<span className="text-[#60d1db]">%</span></div>
                  </div>
                </div>
              </div>
            </div>
