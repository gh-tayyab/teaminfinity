    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 top-20 md:top-30 flex flex-col items-center justify-center px-6 md:px-8 text-center z-10">
          ...
          >
            Grow Your Online Presence with Strategic
          </motion.h1>
          ...
          >
            We design marketing campaigns that increase visibility and conversions. From SEO to
            social media and paid ads, Team Infinity helps your brand connect with audiences and
