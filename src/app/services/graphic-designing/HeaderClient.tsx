      ...
      >
        ...
        <div className="block md:hidden relative w-full h-[80vh]">
          <Image
            ...
            alt="Graphic Design Mobile Background"
            fill
            className="object-cover object-center"
            priority
          />
        ...
        <div className="absolute inset-0 top-20 md:top-30 flex flex-col items-center justify-center px-6 md:px-8 text-center z-10">
          ...
          >
            We design logos, banners, and visuals that make your brand stand out. 
            Team Infinity helps businesses build clear, consistent, and attractive 
            designs for online and offline platforms.
          </motion.p>
        </div>
