    ...
    <main>
      ...
      >
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          {/* LEFT CONTENT */}
          <header className="flex flex-col justify-center items-start text-left">
            <h1
              id="about-heading"
            ...
            <p className="text-gray-600 max-w-md mb-6">
              With offices in Pakistan and London,{" "}
              <span className="font-bold">Team Infinity</span> connects global
              ...
              up to <span className="font-bold">30% lower rates than the market</span>{" "}
              without compromising on quality, experience, or performance.
              Having worked with over{" "}
              <span className="font-bold">
                500 local businesses and 64 international companies
              </span>
              , we deliver premium results that drive real growth.
            </p>
          ...
          {/* RIGHT IMAGE */}
          <figure className="relative flex justify-center md:justify-end items-center">
